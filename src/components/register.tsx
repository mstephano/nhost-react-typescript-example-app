...
export function Register() {
  ...
  return (
    <div className="max-w-lg mx-auto pt-12">
      <h1 className="w-full text-center text-2xl mb-3">Nhost Example Register</h1>
      ...
      <div className="w-full text-center uppercase text-gray-600 py-8">or sign up with</div>
      <div className="mb-8">
        <a
          ...
          <div className="flex items-center text-xl pl-3">Sign up with Github</div>
        </a>
        <a
          className="flex rounded border hover:bg-gray-100 hover:shadow transition ease-in-out duration-200 mb-4"
          href={`${BACKEND_ENDPOINT}/auth/providers/google`}>
          <img className="p-3 border-r" src={google} alt="google" />
          <div className="flex items-center text-xl pl-3">Sign up with Google</div>
        </a>
        <a
          className="flex rounded border hover:bg-gray-100 hover:shadow transition ease-in-out duration-200 mb-4"
          href={`${BACKEND_ENDPOINT}/auth/providers/facebook`}>
          <img className="p-3 border-r" src={facebook} alt="facebook" />
          <div className="flex items-center text-xl pl-3">Sign up with Facebook</div>
        </a>
      </div>
