...
export function Login() {
  ...
  return (
    <div className="max-w-lg mx-auto pt-12">
      ...
      <div className="w-full text-center uppercase text-gray-600 py-8">or sign in with</div>
      <div className="mb-8">
        <a
          ...
          <div className="flex items-center text-xl pl-3">Sign in with Github</div>
        </a>
        <a
          className="flex rounded border hover:bg-gray-100 hover:shadow transition ease-in-out duration-200 mb-4"
          href={`${BACKEND_ENDPOINT}/auth/providers/google`}>
          <img className="p-3 border-r" src={google} alt="google" />
          <div className="flex items-center text-xl pl-3">Sign in with Google</div>
        </a>
        <a
          className="flex rounded border hover:bg-gray-100 hover:shadow transition ease-in-out duration-200 mb-4"
          href={`${BACKEND_ENDPOINT}/auth/providers/facebook`}>
          <img className="p-3 border-r" src={facebook} alt="facebook" />
          <div className="flex items-center text-xl pl-3">Sign in with Facebook</div>
        </a>
      </div>
